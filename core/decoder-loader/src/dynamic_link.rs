...
impl DecoderPlugin {
    pub(crate) fn load_plugin(library_name: &str) -> Result<Self, DecoderError> {
...
pub(crate) fn load_decoder_dynamic(manifests: &DecoderManifests, format: &str) -> Result<DecoderPlugin, DecoderError> {
