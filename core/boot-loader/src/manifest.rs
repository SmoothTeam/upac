...
use super::layout::boot_plugins::{BOOT_PLUGINS_DIR, MANIFEST_EXTENSION};

#[derive(Debug, Clone, Deserialize)]
pub(crate) struct BootPluginManifest {
    pub(crate) name: String,
    pub(crate) library: String,
}

pub(crate) struct BootPluginManifests(pub(crate) HashMap<String, BootPluginManifest>);

impl BootPluginManifests {
    pub(crate) fn new() -> Result<Self, BootPluginError> {
